...
import logoRSI from 'src/images/logos/rsi.webp'
import logoFluentStream from 'src/images/logos/fluentstream.webp'
import logoICS from 'src/images/logos/ics.webp'
import logoDecypher from 'src/images/logos/decypher.webp'
...
export default function Home({ articles }) {
  return (
    <>
      <Head>
        <title>
          John Weland - Solutions Architect, Father, Husband, and Entrepreneur.
        </title>
        <meta
          name="description"
