...
export default function About() {
  return (
    <>
      <Head>
        <title>About - John Weland [dot] Me</title>
        <meta
          name="description"
          content="I’m John Weland. I live in New York City, where I design the future."
        />
      </Head>
        ...
        <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
          ...
          <div className="lg:order-first lg:row-span-2">
            <h1 className="text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
              I’m John Weland. A Texan living in rural Minnesota, where I help
              companies build their futures.
            </h1>
            <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
              ...
              <p>
                I am a husband and a father. My girls do not always understand
                my &quot;nerd-isms&quot;, but they have learned to just smile
                and nod when I go on a tangent about new games, programming
          ...
          <div className="lg:pl-20">
            <ul role="list">
              ...
              <SocialLink
                href="https://linkedin.com/in/johnweland"
                icon={LinkedInIcon}
                className="mt-4"
              >
                Follow on LinkedIn
              ...
              <SocialLink
                href="mailto:john.weland@gmail.com"
                icon={MailIcon}
