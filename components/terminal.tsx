...
const Terminal = ({ children, ...props }) => {
  ...
  return (
    <>
      ...
      <div className="relative rounded-2xl bg-neutral-900/90 dark:bg-neutral-900/80 ring-1 ring-indigo/10 backdrop-blur">
        <div className="absolute -top-px left-20 right-11 h-px bg-gradient-to-r from-indigo-300/10 via-indigo-300/70 to-indigo-300/10" />
        <div className="absolute -bottom-px left-11 right-20 h-px bg-gradient-to-r from-indigo-400/10 via-indigo-400 to-indigo-400/10" />
